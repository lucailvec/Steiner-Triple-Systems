...
\begin{frame}
We have to prove (in a similar way) there are the right number of $t \in T$ and every pair (from $\binom{6n + 1}{2}$) is contained almost 1.
